...
public class History extends javax.swing.JFrame {
    ...
    public History(String id) {
        ...
        String query = "SELECT id,title,author,category,log.borrower,log.returned_on FROM log INNER JOIN book_details ON log.borrower = "+id+" AND bookid = id ORDER BY returned_on DESC;";
        try{
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 20, 470, 35));
        ...
        getContentPane().add(jButton9, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 20, 40, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(14, 73, 633, 312));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/lib2.jpg"))); // NOI18N
        jLabel2.setBorder(null);
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(-3, 0, 680, 420));
