...
public class ViewBooks extends javax.swing.JFrame {
    ...
    public ViewBooks(boolean admin) {
        initComponents();
        try{
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 30, 240, 40));
        ...
        getContentPane().add(jButton9, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 30, 40, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(18, 93, 712, 338));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/lib2.jpg"))); // NOI18N
        jLabel2.setBorder(null);
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(-3, 0, 760, 470));

        pack();
        setLocationRelativeTo(null);
    }// </editor-fold>//GEN-END:initComponents

    void showInfo(boolean type){
        String query;
        if(type){
            query = "SELECT * FROM book_details;";
        }else{
            query = "SELECT id,title,author,category FROM book_details;";
        }
